...
vim.keymap.set('n', '<C-d>', '<C-d>zz') -- Scrolls down half a screen and centers the cursor
vim.keymap.set('n', '<C-u>', '<C-u>zz') -- Scrolls up half a screen and centers the cursor
